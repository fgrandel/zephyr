...
# are mapped to bindings via their 'compatible = "..."' property.
#
...
from settings.configuration.configtree import ConfigTree as ConfigTree  # YAML
from settings.devicetree.edtree import EDTree as EDTree  # devicetree
...
def zephyr_build_stree(
    ...
    try:
        ...
        stree.add_partial_tree("dts", edt_tree)

        config_tree = ConfigTree(config_path, err_on_deprecated=strict)
        stree.add_partial_tree("config", config_tree)
