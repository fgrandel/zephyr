...
find_program(CMAKE_SETTINGS_PREPROCESSOR ${ZEPHYR_SDK_CROSS_COMPILE}gcc PATHS ${ZEPHYR_SDK_INSTALL_DIR} NO_DEFAULT_PATH)
message(STATUS "Found dts preprocessor: ${CMAKE_SETTINGS_PREPROCESSOR} (Zephyr SDK ${SDK_VERSION})")
