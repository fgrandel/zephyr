...
if(DEFINED SETTINGS_FILES AND NOT SETTINGS_FILES STREQUAL "")
  ...
  if(NOT DEFINED SETTINGS_FILES OR SETTINGS_FILES STREQUAL "")
    # If we don't have any board settings, provide at least an empty devicetree stub.
...
.overlay (devicetree) and .settings.yaml (configuration) file using this \
...
SETTINGS_OVERLAY_FILES=\"dts1.overlay dts2.overlay config.settings.yaml\". If \
