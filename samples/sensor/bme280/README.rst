...
.. zephyr-app-commands::
   :zephyr-app: samples/sensor/bme280
   :goals: build flash
   :gen-args: -DSETTINGS_OVERLAY_FILES=arduino_spi.overlay
...
.. zephyr-app-commands::
   :zephyr-app: samples/sensor/bme280
   :goals: build flash
   :gen-args: -DSETTINGS_OVERLAY_FILES=arduino_i2c.overlay
...
.. zephyr-app-commands::
   ...
   :goals: build flash
   :board: rpi_pico
   :gen-args: -DSETTINGS_OVERLAY_FILES=rpi_pico_spi_pio.overlay
...
no ``SETTINGS_OVERLAY_FILES`` setting is needed when building and running.
