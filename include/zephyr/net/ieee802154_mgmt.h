...
enum net_request_ieee802154_cmd {
	...
	NET_REQUEST_IEEE802154_CMD_SET_DEVICE_ROLE,
	NET_REQUEST_IEEE802154_CMD_GET_DEVICE_ROLE,
 ...
 *  - MLME-SET-SLOTFRAME.request, see section 8.2.19
 *  - MLME-SET-LINK.request, see section 8.2.19
 *
 ...
 * Set the device role
 *
 * @note Device roles are not explicitly defined in the standard but required to
 * define device behavior.
 */
#define NET_REQUEST_IEEE802154_SET_DEVICE_ROLE                          \
	(_NET_IEEE802154_BASE | NET_REQUEST_IEEE802154_CMD_SET_DEVICE_ROLE)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_IEEE802154_SET_DEVICE_ROLE);

/** Read the device role */
#define NET_REQUEST_IEEE802154_GET_DEVICE_ROLE                          \
	(_NET_IEEE802154_BASE | NET_REQUEST_IEEE802154_CMD_GET_DEVICE_ROLE)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_IEEE802154_GET_DEVICE_ROLE);
 ...
 */
#define NET_REQUEST_IEEE802154_SET_TSCH_SLOTFRAME                                                  \
	(_NET_IEEE802154_BASE | NET_REQUEST_IEEE802154_CMD_SET_TSCH_SLOTFRAME)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_IEEE802154_SET_TSCH_SLOTFRAME);

/**
 * Deletes a TSCH slotframe, i.e. an MLME-SET- SLOTFRAME request with DELETE
 * operation
 */
#define NET_REQUEST_IEEE802154_DELETE_TSCH_SLOTFRAME                                               \
	(_NET_IEEE802154_BASE | NET_REQUEST_IEEE802154_CMD_DELETE_TSCH_SLOTFRAME)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_IEEE802154_DELETE_TSCH_SLOTFRAME);

/**
 * Adds or edits TSCH links, i.e. an MLME-SET-LINK request with ADD/MODIFY
 * operation
 */
#define NET_REQUEST_IEEE802154_SET_TSCH_LINK                                                       \
	(_NET_IEEE802154_BASE | NET_REQUEST_IEEE802154_CMD_SET_TSCH_LINK)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_IEEE802154_SET_TSCH_LINK);

/** Deletes a TSCH link, i.e. an MLME-SET-LINK request with DELETE operation) */
#define NET_REQUEST_IEEE802154_DELETE_TSCH_LINK                                                    \
	(_NET_IEEE802154_BASE | NET_REQUEST_IEEE802154_CMD_DELETE_TSCH_LINK)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_IEEE802154_DELETE_TSCH_LINK);
