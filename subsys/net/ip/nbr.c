...
#endif
#ifdef CONFIG_NET_L2_IEEE802154_MAX_NEIGHBORS
#define IEEE802154_MAX_NEIGHBORS CONFIG_NET_L2_IEEE802154_MAX_NEIGHBORS
#else
#define IEEE802154_MAX_NEIGHBORS 0
#endif
#define MAX_NEIGHBORS (IPV6_MAX_NEIGHBORS + IEEE802154_MAX_NEIGHBORS)
